...
function showReviewPopup() {
    ...
    document.getElementById('submit-review-btn').addEventListener('click', () => {
        ...
        // Використовуємо відносний URL із мовним префіксом
        const currentPath = window.location.pathname; // Наприклад, "/en/some-page/"
        const languagePrefix = currentPath.split('/')[1]; // Отримуємо "en"
        ...
        fetch(submitUrl, {
            ...
            headers: {
                ...
                'Cache-Control': 'no-cache', // Відключаємо кешування
            },
